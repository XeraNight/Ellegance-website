                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-6 border-t border-gray-100 flex items-center justify-between">
                    ...
                    <div className="flex gap-4">
                      <a href="https://www.instagram.com/ellegance_danceclub/" target="_blank" rel="noopener noreferrer" className="w-5 h-5 text-gray-400 hover:text-gold-500 transition-colors">
                      ...
                      <a href="https://www.facebook.com/ellegance.koce" target="_blank" rel="noopener noreferrer" className="w-5 h-5 text-gray-400 hover:text-gold-500 transition-colors">
