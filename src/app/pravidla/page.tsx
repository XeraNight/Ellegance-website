        ...
        <section className="pt-20 border-t border-white/5">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-3xl">
              <a 
                href="https://szts.sk/sk/dokumenty/legislativa" 
                target="_blank" 
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-white font-medium">Súťažný poriadok 2026</span>
                </div>
                <span className="text-gray-600 group-hover:text-gold-500 transition-colors">PDF</span>
              </a>
              <a 
                href="https://szts.sk" 
                target="_blank" 
