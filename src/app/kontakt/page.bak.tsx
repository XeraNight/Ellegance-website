        ...
        <div className="w-full lg:w-[55%] flex flex-col justify-center animate-fade-in-up" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
          ...
          >
            ...
            <div className="relative z-10">
              <h1 className="font-serif text-3xl md:text-4xl text-[#2a2624] mb-10 text-center border-b border-[#c4b5a9] pb-6 italic">Kontaktný formulár</h1>
              ...
              {success ? (
                ...
                >
                  <div className="w-16 h-16 bg-[#e6dfd9] text-[#2a4494] rounded-full flex items-center justify-center mb-6 shadow-sm border border-[#c4b5a9]">
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  <h3 className="font-serif text-2xl md:text-3xl text-[#2a2624] mb-4 italic">Správa odoslaná</h3>
                  <p className="font-sans text-sm text-[#8c7e74] max-w-sm leading-relaxed mb-8">
                    Vaša správa bola úspešne odoslaná. Čoskoro vás budeme kontaktovať, aby sme dohodli ďalšie kroky!
                  </p>
                  <button 
                    onClick={() => setSuccess(null)}
                    className="btn-gold py-3 px-8 rounded-full font-serif text-sm italic tracking-wider shadow-lg"
                  >
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <select 
                      ...
                      disabled={loading}
                    >
                      <option value="" disabled className="font-sans text-sm">Vyberte možnosť...</option>
                      <option value="svadba" className="font-sans text-sm">Svadobný tanec</option>
                      <option value="latinfit" className="font-sans text-sm">Latin Fit</option>
                      <option value="senior" className="font-sans text-sm">Spoločenské tance pre seniorov</option>
                      <option value="ine" className="font-sans text-sm">Iná požiadavka...</option>
                    </select>
                  </div>
                  ...
                  {error && (
                    <motion.p 
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      className="text-red-500 font-sans text-xs text-center font-bold"
                    >
                      {error}
                    </motion.p>
                  )}
                  ...
                  <div className="mt-4 flex justify-center lg:justify-start">
                    <motion.button 
                      whileTap={{ scale: 0.98 }}
                      type="submit" 
                      className="btn-gold py-4 px-12 rounded-full font-serif text-lg italic tracking-wider shadow-xl disabled:opacity-55 disabled:cursor-not-allowed"
                      disabled={loading}
                    >
